...
scalar_columns = ["JS-age", "JS-daily_hours_willing_to_work", "JS-days_willing_train_unpaid", "JS-distance_willing_to_travel", "JS-years_education", "JS-years_exp", "JS-rwage1", "JS-num_children", "JS-personal_income", "JOB-num_vacancies", "JOB-wage_offered"]
